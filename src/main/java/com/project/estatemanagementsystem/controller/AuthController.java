...
public class AuthController {
    ...
    public String pewarisDetail(@PathVariable("id") Long id, Model model){
    ...
    public String pewarisProperty(@PathVariable("id") Long id, Model model){
    ...
    public String pewarisHeirs(@PathVariable("id") Long id, Model model){
    ...
    public String adminDelete(@PathVariable("id") Long id, Model model){
    ...
    public String pewarisWasiat(@PathVariable("id") Long id, Model model){
