...
import com.project.estatemanagementsystem.dto.AdditionalWasiatDto;
...
public class WasiatController {
    ...
    public String createWasiat(@ModelAttribute("wasiat") WasiatDto wasiatDto, @ModelAttribute("additionalWasiat") AdditionalWasiatDto awd) {
        ...
        wasiatService.saveAdditionalWasiat(awd.getUser(), awd.getIsteriName(), awd.getAnakLelakiName(), awd.getAnakPerempuanName(), awd.getAnakAngkatName());
        return "users";
    }
